...
def make_plot(model_type,method,file_out):
    ...
    file_names_g00001 = ["T2-0_Lambda1-4_eps1_g0-0001.csv",
    ...
    file_names_g0001 = ["T2-0_Lambda1-4_eps1_g0-001.csv",
    ...
    file_names_g001 = ["T2-0_Lambda1-4_eps1_g0-01.csv",
    ...
    file_names_g01 = ["T2-0_Lambda1-4_eps1_g0-1.csv",
                  "T3-0_Lambda1-4_eps1_g0-1.csv",
                  "T4-0_Lambda1-4_eps1_g0-1.csv",
                  "T5-0_Lambda1-4_eps1_g0-1.csv",
                  "T6-0_Lambda1-4_eps1_g0-1.csv",
                  "T7-0_Lambda1-4_eps1_g0-1.csv",
                  "T8-0_Lambda1-4_eps1_g0-1.csv",
                  "T9-0_Lambda1-4_eps1_g0-1.csv",
                  "T10-0_Lambda1-4_eps1_g0-1.csv",
                  "T20-0_Lambda1-4_eps1_g0-1.csv",
                  "T30-0_Lambda1-4_eps1_g0-1.csv",
                  "T40-0_Lambda1-4_eps1_g0-1.csv",
                  "T50-0_Lambda1-4_eps1_g0-1.csv"]
...
def plot_kappa_vec(plotter,fig,gs,file_names,model_type,method):
    ...
    results = get_kappa(plotter,file_names,model_type,method,equil="equil",constrained_kappa="pass")
    results2 = get_kappa(plotter,file_names,model_type,method,equil="noneq",constrained_kappa="pass")
...
if __name__=="__main__":
    ...
    method = "indirect"
    make_plot(model_type,method,f"plots/kappa_v_time{model_type}_{method[0]}.png")
