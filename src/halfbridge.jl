...
function integrate_half_gaussian(ARGS)
    ...
    function varbc!(residual, u, p, t)
        ...
        residual[4] = u[end][1] - Vqq_end(u[end][4]) #Vqq_end #the solution at the end
    ...
    CSV.write("variance_half.csv",df_var)
    
    println("variance csv ready.")

    pos_sigma_final_estimate = sol1(T,idxs=4)
    ...
    function meanbc!(residual, u, p, t)
        ...
        residual[3] = u[end][3] - vq_end(u[end][1],pos_sigma_final_estimate) #the solution at the end
    ...
    CSV.write("mean_half.csv",df_mean)
